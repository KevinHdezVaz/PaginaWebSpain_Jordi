            ...
            <div className="max-w-7xl mx-auto px-6 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-y-12 gap-x-8">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-earth-light leading-relaxed opacity-90 text-sm">
                    ...
                    <div className="lg:col-span-2">
                        <h3 className="text-xl font-bold mb-6 text-white text-center md:text-left">Contacto</h3>
                        <ul className="space-y-10 opacity-90">
                            <li className="flex items-center">
                                <svg className="w-5 h-5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                                </svg>
                                <span>+34 633 399 756</span>
                            </li>
                            <li className="flex items-start">
                                ...
                                <div className="flex flex-col space-y-3">
                                    <a href="mailto:Jordi.Alos@gravelemporda.com" className="hover:text-earth-green transition-colors break-all lg:break-normal">
                                        Jordi.Alos@gravelemporda.com
                                    </a>
                                    <a href="mailto:info@gravelemporda.com" className="hover:text-earth-green transition-colors">
                                        info@gravelemporda.com
                                    </a>
                                </div>
                            </li>
                            <li className="flex items-start">
                                ...
                                <span className="flex-1">L'Escala 17130 Alt Empordà (Girona) Catalunya - Spain</span>
                            </li>
                        </ul>
                    </div>
